...
interface CorsErrorModalProps {
  corsErrorModalOpen: any;
  setCorsErrorModalOpen: any;
}

const CorsErrorModal: React.FunctionComponent<CorsErrorModalProps> = (
  props
) => {
  const { corsErrorModalOpen, setCorsErrorModalOpen } = props;
  ...
  return (
    <Modal
      onExit={() => setCorsErrorModalOpen(false)}
      show={corsErrorModalOpen}
      // closeIcon
    >
