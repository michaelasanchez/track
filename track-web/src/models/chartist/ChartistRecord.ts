...
export class ChartistRecord {
  ...
  constructor(series: ApiSeries, id: number, timestamp: string, value?: string, index?: number) {
    ...
    this.meta = getRecordTooltip(id, series.Label, value);
    this.x = moment(timestamp);
    this.y = parsedValue;
  }
